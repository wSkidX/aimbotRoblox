...
local function safeLoadSignal()
    local ok, signal = pcall(function()
        return loadstring(game:HttpGet('https://raw.githubusercontent.com/Quenty/NevermoreEngine/main/src/signal/src/Shared/Signal.lua'))()
    end)
    if not ok or type(signal) ~= "table" then
        warn("[Octohook] Gagal load Signal dari Quenty/NevermoreEngine!")
...
print("[Octohook] Library loaded. Signal: ", library.signal)
        ...
        do
            ...
            do
                ...
                objs.sat1 = utility:Draw('Image', {
                    Size = newUDim2(1,0,1,0);
                    Data = syn.crypt.base64.decode"";
                    ZIndex = z+3;
